...
LexiBridge Translate is a browser extension for user-triggered page translation, side-panel text translation, document text translation, selected or currently visible image text translation, video subtitle text translation, user-selected local media transcription, live caption text translation and local transcript export, selection translation, vocabulary collection, and vocabulary review.
...
Translation provider requests happen only after the user asks LexiBridge to translate side-panel text, run an AI side-panel writing action, transcribe a selected local media file, translate selected text, document text, selected image text, eligible currently visible image text, available video subtitle text, visible live caption text, or a page.
