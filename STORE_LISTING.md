...
- Manual image text translation using browser OCR or bundled offline OCR, plus SVG and accessibility text fallbacks, with click/drag selection, a user-triggered visible-image batch, bounded local comic-bubble reconstruction when safe, and non-destructive OCR block overlays otherwise.
